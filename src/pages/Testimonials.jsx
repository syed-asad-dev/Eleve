  ...
  return (
    <div className="w-full pt-24 bg-dark-900 min-h-screen">
      ...
      <div className="text-center py-16">
        <p className="text-accent-green tracking-[0.2em] uppercase text-sm font-bold">Client Feedback</p>
        <h1 className="text-5xl md:text-6xl font-heading text-white mt-4 mb-6">Testimonials</h1>
